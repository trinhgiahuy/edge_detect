...
#define GET_INPUT_OFFSET                  REG_READ(INPUT_OFFSET_ADDR)  
#define GET_OUTPUT_OFFSET                 REG_READ(OUTPUT_OFFSET_ADDR)  
#define GET_HEIGHT                        REG_READ(HEIGHT_ADDR)  
#define GET_WIDTH                         REG_READ(WIDTH_ADDR)  
