...
//w_slave<>  CCS_INIT_S1(w_acc);
  ...
  static const int numSlaves            =  3;  // will be 4 with accelerator added
  static const int numMasters           =  1;  // will be 2 with accelerator added
...
//  cpu_router.addrBound[3][0](addrBound[3][0]);
//  cpu_router.addrBound[3][1](addrBound[3][1]);
...
//  acc_router.addrBound[3][0](addrBound[1][0]);
//  acc_router.addrBound[3][1](addrBound[1][1]);
...
//  uart_arbiter.axi_wr_m_b[1] (w_acc2uart.b);
    ...
    timer_arbiter.clk(clk);
    timer_arbiter.reset_bar(rst_bar);

    timer_arbiter.axi_rd_m_ar[0](r_cpu2timer.ar);
    timer_arbiter.axi_rd_m_r[0] (r_cpu2timer.r);
    timer_arbiter.axi_wr_m_aw[0](w_cpu2timer.aw);
    timer_arbiter.axi_wr_m_w[0] (w_cpu2timer.w);
    timer_arbiter.axi_wr_m_b[0] (w_cpu2timer.b);
    
//  timer_arbiter.axi_rd_m_ar[1](r_acc2timer.ar);
//  timer_arbiter.axi_rd_m_r[1] (r_acc2timer.r);
//  timer_arbiter.axi_wr_m_aw[1](w_acc2timer.aw);
//  timer_arbiter.axi_wr_m_w[1] (w_acc2timer.w);
//  timer_arbiter.axi_wr_m_b[1] (w_acc2timer.b);
