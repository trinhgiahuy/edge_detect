...
OUTPUT_DIR       ./
FILES {
  { FILENAME ./ram_1k_64_sp.v           FILETYPE Verilog PATHTYPE relative MODELTYPE GENERIC   PARSE 1 STATICFILE 1 VHDL_LIB_MAPS work }
  { FILENAME ./ram_1k_64_sp_liberty.lib FILETYPE Liberty PATHTYPE relative MODELTYPE synthesis PARSE 1 STATICFILE 1 VHDL_LIB_MAPS work }
}
LIBS_LEF         ram_1k_64_sp.lef
VHDLARRAYPATH    mem
WRITEDELAY       0.1
INITDELAY        1
READDELAY        0.4
...
WRITELATENCY     1
LIBS_LIBERTY     ram_1k_64_sp_liberty.lib
VHDL_LIB_MAPS    {work ./work nangate45_mem_lib ./work}
READLATENCY      1
DEPTH            depth
PARAMETERS {
  { PARAMETER data_width TYPE hdl IGNORE 0 MIN 64 MAX 64 DEFAULT 64 }
