#ifndef __INCLUDED_ram_1k_64_sp_H__
#define __INCLUDED_ram_1k_64_sp_H__

// SystemC memory model of ram_1k_64_sp
// Generated by Catapult memory generator
// Generated by:   michaelf
// Generated date: Sun Nov  7 14:08:05 2021

// The following classes have been defined:
//     class ram_1k_64_sp a 0 delay "structural" model of the RAM

//     class ram_1k_64_sp_model<TLM/SYN>::mem<T,size,TLM/SYN>
//         A memory model that can be instanced and used for simulation and synthesis

//     class ram_1k_64_sp_model<TLM/SYN>::port_0_port<T,size,TLM/SYN>
...
#pragma map_to_operator ram_1k_64_sp
template <
  int ram_id,
  int data_width,
  int addr_width,
  int depth>
class ram_1k_64_sp : public sc_module
{
public:
    ...
    if ( chip_en.read() ) {
      ...
      if ((chip_en==1) && (wr_en==1)) {
        ...
        if( address<0 || address >=depth ) { 
          ...
          msg << "ram_1k_64_sp out-of-bounds write detected to address " << address << " mapped to address=0";
      ...
      if ( (rd_en==1) ) {
        ...
        if( address<0 || address >=depth ) { 
          std::ostringstream msg;
          msg << "ram_1k_64_sp out-of-bounds read detected from address "<< address << " mapped to address=0";
          SC_REPORT_WARNING(this->name(), msg.str().c_str());
          address = 0;
        }
        q.write( mem[address] );
...
public:
  ...
  private:
    ram_1k_64_sp<0, data_width, addr_width, size> RAM;
  };
...
#endif // ifndef __INCLUDED_ram_1k_64_sp_H__
