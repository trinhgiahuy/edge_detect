#ifndef __INCLUDED_ram_1k_64_sp_trans_rsc_H__
#define __INCLUDED_ram_1k_64_sp_trans_rsc_H__
...
template < 
  ...
  ,int depth
>
class ram_1k_64_sp_trans_rsc : public mc_wire_trans_rsc_base<data_width,depth>
{
public:
  ...
  SC_HAS_PROCESS( ram_1k_64_sp_trans_rsc );
  ram_1k_64_sp_trans_rsc(const sc_module_name& name, bool phase, double clk_skew_delay=0.0)
  ...
  virtual void start_of_simulation() {
    ...
    if (base::_holdtime > 0) {
      ...
      msg << "ram_1k_64_sp_trans_rsc CLASS_STARTUP - CLK_SKEW_DELAY = "
...
#endif // ifndef __INCLUDED_ram_1k_64_sp_trans_rsc_H__
