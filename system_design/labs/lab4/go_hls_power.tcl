...
go new
options set Input/CompilerFlags -DSINGLEPORT
go compile
solution rename -solution EdgeDetect_Hierarchy.v1 EdgeDetect_Singleport_Shift
...
solution new -state new -solution EdgeDetect_Singleport_Shift.v1 EdgeDetect_Singleport_Circular
options set Input/CompilerFlags -DCIRCULAR
go extract
go switching
flow run /PowerAnalysis/report_pre_pwropt_Verilog

solution select EdgeDetect_Singleport_Shift.v1
